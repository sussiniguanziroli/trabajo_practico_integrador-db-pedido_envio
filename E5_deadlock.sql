-- ETAPA 5
-- 1. Simular una Deadlock, se va a simular que pasa cuando sos sesiones compiten por los mismos recuros.

-- TERMINAL 1:
USE tpi_pedido_envio;
START TRANSACTION;
UPDATE PRODUCTO SET stock_disponible = stock_disponible - 1 WHERE id_producto = 1;
-- No hacer COMMIT ni rollback; esparar a ejecutar la TERMINAL 2.
